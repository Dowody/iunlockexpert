import{i as N,a as k,x as a,r as L,h as v,G as p,f as O,R as Y,j as V,A as z,W as E,O as W}from"./index-BYGxSI-6.js";import{n as l,c as _,o as S,r as b}from"./if-defined-D92FCs1-.js";import{T as A,D as F}from"./index-ChLj85At.js";import"./index--E05O1wJ.js";import"./index-CUk-kCKA.js";import"./index-CtaSCs2w.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
