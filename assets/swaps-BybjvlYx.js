import{i as C,a as U,h as A,N as D,x as u,d as K,j as W,R as S,A as j,f as V,M,W as F,r as Q,k as q}from"./index-B40uI0Zo.js";import{r as a,n as g,c as E,U as m}from"./if-defined-DOaQPEME.js";import"./index-Bl2raK90.js";import{M as R}from"./index-CugHNx_Y.js";import"./index-DmkJLBDm.js";import{S as n}from"./index-DDEL6Hxa.js";import"./index-GW7a5fQe.js";import"./index-B7eQ1MAY.js";import"./index-14KW7_So.js";import"./index-DabiM6Qr.js";import"./index-Dzpw8v0i.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
