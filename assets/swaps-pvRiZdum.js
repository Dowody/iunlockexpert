import{i as C,a as U,e as A,N as D,x as u,b as K,f as W,R as S,A as j,d as V,M,W as F,r as Q,h as q}from"./index-D3ZrTiH1.js";import{r as a,n as g,c as E,U as m}from"./if-defined-H4-zvNBd.js";import"./index-CgypUcMq.js";import{M as R}from"./index-DZRfy3QD.js";import"./index-BQave1Ec.js";import{S as n}from"./index-TwKauBaW.js";import"./index-nw6OBVIC.js";import"./index-BbybGAIn.js";import"./index-BpE6a6vQ.js";import"./index-0FuEEw0r.js";import"./index-ClwLz-6r.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
